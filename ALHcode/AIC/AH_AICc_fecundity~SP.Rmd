...
fec_work_model2 <- lm(Estimated_Fecundity ~ Avg_Work, data = location_estimates_noLL)
summary(fec_work_model2)

ggplot(location_estimates_noLL, aes(x = Avg_Work, y = Estimated_Fecundity, label = Location)) +
  geom_point(size = 3) +
  geom_smooth(method = "lm", se = TRUE, color = "blue") +
