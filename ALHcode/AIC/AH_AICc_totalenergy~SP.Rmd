...
model10 <- lm(TotalEnergy_mJ~ Gonad_Wt_g + Work + Sex + Year, data = DataSet)
```
...
TEaic_df$ModelName <- c("TotalEnergy_mJ~ Gonad_Wt_g + Work + Sex + Year",
...
manual_likelihoods <- c(
  ...
  "Year2021" = 0.9872105, 
  "SexM" = 0.9999564,
  "SexM:Work164.7" = 8.631624e-05,
  "SexM:Work171.6" = 8.631624e-05,
  "SexM:Work298.2" = 8.631624e-05,
  "SexM:Work416.8" = 8.631624e-05,
  "SexM:Work443.1" = 8.631624e-05,
  "SexM:Work471.1" = 8.631624e-05,
