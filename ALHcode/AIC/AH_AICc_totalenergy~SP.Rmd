...
upperriver_bodycomp_all$Carcass.guts_Wt_g <- upperriver_bodycomp_all$Carcass.guts_Wt * 1000
upperriver_bodycomp_all$TotalEnergy_mJ <- upperriver_bodycomp_all$EnergyPDry_1_mJ_g * upperriver_bodycomp_all$Fish_Wt_g
upperriver_bodycomp_all$TotalEnergy_carcass_mJ <- upperriver_bodycomp_all$EnergyPDry_1_mJ_g * upperriver_bodycomp_all$Carcass.guts_Wt_g
str(upperriver_bodycomp_all)

write.csv(upperriver_bodycomp_all, "upperriver_bodycomp_TotalEnergy_1.12.2026.csv")
```
...
```{r, include = FALSE}
rm(list = ls())
upperriver_bodycomp_TotalEnergy <- "upperriver_bodycomp_TotalEnergy_1.12.2026.csv"
...
DataSet[is.na(DataSet$TotalEnergy_carcass_mJ), ] #Row 35 does not have a Total Energy value, so eliminate for analysis
DataSet <- DataSet[-c(18,22,35,36,40,61,65,70,77,87,102,110,118,141,142,144,154,161,164,221, 222,224),] #excludes row missing sex file
any(is.na(DataSet$Sex)) #FALSE
any(is.na(DataSet$Gonad_Wt_g)) #FALSE
any(is.na(DataSet$TotalEnergy_carcass_mJ))
...
model2 <- lm(TotalEnergy_carcass_mJ~ Gonad_Wt_g + Collection_Location, data = DataSet)
model3 <- lm(TotalEnergy_carcass_mJ~ Gonad_Wt_g + Sex, data = DataSet)
model4 <- lm(TotalEnergy_carcass_mJ~Gonad_Wt_g + Year, data = DataSet)
model5 <- lm(TotalEnergy_carcass_mJ~ Gonad_Wt_g + Collection_Location + Sex, data = DataSet)
model6 <- lm(TotalEnergy_carcass_mJ~ Gonad_Wt_g + Collection_Location + Year, data = DataSet)
model7 <- lm(TotalEnergy_carcass_mJ~ Gonad_Wt_g + Sex + Year, data = DataSet)
model8 <- lm(TotalEnergy_carcass_mJ~ Gonad_Wt_g + Collection_Location + Sex + Collection_Location:Sex, data = DataSet)
model9 <- lm(TotalEnergy_carcass_mJ~Gonad_Wt_g + Sex + Year + Sex:Year, data = DataSet)
model10 <- lm(TotalEnergy_carcass_mJ~ Gonad_Wt_g + Collection_Location + Sex + Year, data = DataSet)
...
write.csv(TEaic_df, file = "totalenergy2_spawningpopulation/AICresults_TotalEnergy~SpawningPopulation.csv", row.names = FALSE)
...
manual_likelihoods <- c(
  ...
  "Year2020" = 9.204447e-01,
  "Year2021" = 9.204447e-01, 
  "SexM" = 1.00000,
  "SexM:Year2020" = 3.629613e-11,
  "SexM:Year2021" = 3.629613e-11,
  "Collection_LocationGulkana Hatchery:SexM" = 2.054929e-03,
  "Collection_LocationLong Lake:SexM" = 2.054929e-03,
  "Collection_LocationMahlo:SexM" = 2.054929e-03,
  "Collection_LocationMentasta:SexM" = 2.054929e-03,
  "Collection_LocationSt Anne:SexM" = 2.054929e-03,
  "Collection_LocationTanada:SexM" = 2.054929e-03
)
...
write.csv(coefs_df_full, file = "totalenergy2_spawningpopulation/TotalEnergy_SP_ModelAvg_Coefs_withLikelihoods.csv", row.names = TRUE)
