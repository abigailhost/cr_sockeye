...
model3 <- lm(sizecorrected_bodymass_residuals~Collection_RiverMile_m + Group_Assignment + Sex, data = DataSet)
model4 <- lm(sizecorrected_bodymass_residuals~Collection_RiverMile_m + Group_Assignment + Year, data = DataSet)
model5 <- lm(sizecorrected_bodymass_residuals~Collection_RiverMile_m + Group_Assignment + Sex + Year, data = DataSet)
...
aic_df$ModelName <- c("sizecorrected_bodymass_residuals~Collection_RiverMile_m + Group_Assignment + Sex + Year",
...
manual_likelihoods <- c(
  "(Intercept)" = 1.0,
  "Collection_RiverMile_m" = 0.9982794,
  "Group_AssignmentChitina" = 0.9982794,
  "Group_AssignmentGulkana" = 0.9982794,
  "Group_AssignmentGulkanaHatchery" = 0.9982794,
  "Group_AssignmentKlutinaLake" = 0.9982794,
  "Group_AssignmentKlutinaTonsinaOutlet" = 0.9982794,
  "Group_AssignmentLowerGroups" = 0.9982794,
  "Group_AssignmentSlana" = 0.9982794,
  "Group_AssignmentTanadaCopperLakes" = 0.9982794,
  "Group_AssignmentTazlina" = 0.9982794,
  "SexM" = 0.8055808,
  "Year2021" = 0.5509153
)
