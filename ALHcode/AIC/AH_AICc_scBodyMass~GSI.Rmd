...
model4 <- lm(sizecorrected_bodymass_residuals~Collection_RiverMile_m + Group_Assignment + Sex, data = DataSet)
...
aic_df$ModelName <- c("sizecorrected_bodymass_residuals~Collection_RiverMile_m + Sex",
...
manual_likelihoods <- c(
  "(Intercept)" = 1.0,
  "Collection_RiverMile_m" = 0.9990083,
  "Group_AssignmentChitina" = 0.5131580,
  "Group_AssignmentGulkana" = 0.5131580,
  "Group_AssignmentGulkanaHatchery" = 0.5131580,
  "Group_AssignmentKlutinaLake" = 0.5131580,
  "Group_AssignmentKlutinaTonsinaOutlet" = 0.5131580,
  "Group_AssignmentSlana" = 0.5131580,
  "Group_AssignmentTanadaCopperLakes" = 0.5131580,
  "Group_AssignmentTazlina" = 0.5131580,
  "SexM" = 0.9281743
)
