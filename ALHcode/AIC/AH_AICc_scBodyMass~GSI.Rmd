...
paramestimates_scbmGSI <- "scbodymass_GSI/SizeCorrectedBodyMass_GSI_ModelAvg_Coefs_withLikelihoods.csv"

estimates_scbmGSI<-read.csv(paramestimates_scbmGSI)
str(estimates_scbmGSI)

levels(factor(estimates_scbmGSI$X))
estimates_scbmGSI$X <- factor(estimates_scbmGSI$X, 
...
ggplot(estimates_scbmGSI, aes(x = Avg_Coef, y = X)) + 
