...
model10 <- lm(EnergyPDry_1~ Gonad_Wt_g + Work + Sex + Year, data = DataSet)
```
...
EDaic_df$ModelName <- c("EnergyPDry_1~ Gonad_Wt_g + Work + Sex + Year",
...
manual_likelihoods <- c(
  ...
  "Work443.1" = 1.000000,
  "Work471.1" = 1.000000,
  "Year2020" = 9.999670e-01,
  "Year2021" = 9.999670e-01, 
  "SexM" = 9.939664e-01,
  "SexM:Work164.7" = 2.917088e-07,
  "SexM:Work171.6" = 2.917088e-07,
  "SexM:Work298.2" = 2.917088e-07,
  "SexM:Work416.8" = 2.917088e-07,
  "SexM:Work443.1" = 2.917088e-07,
  "SexM:Work471.1" = 2.917088e-07,
