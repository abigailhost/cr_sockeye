...
model1 <- lm(EnergyPDry_1_mJ_g~1, data=DataSet)
model2 <- lm(EnergyPDry_1_mJ_g~ Gonad_Wt_g + Collection_Location, data = DataSet)
model3 <- lm(EnergyPDry_1_mJ_g~ Gonad_Wt_g + Sex, data = DataSet)
model4 <- lm(EnergyPDry_1_mJ_g~Gonad_Wt_g + Year, data = DataSet)
model5 <- lm(EnergyPDry_1_mJ_g~ Gonad_Wt_g + Collection_Location + Sex, data = DataSet)
model6 <- lm(EnergyPDry_1_mJ_g~ Gonad_Wt_g + Collection_Location + Year, data = DataSet)
model7 <- lm(EnergyPDry_1_mJ_g~ Gonad_Wt_g + Sex + Year, data = DataSet)
model8 <- lm(EnergyPDry_1_mJ_g~ Gonad_Wt_g + Collection_Location + Sex + Collection_Location:Sex, data = DataSet)
model9 <- lm(EnergyPDry_1_mJ_g~Gonad_Wt_g + Sex + Year + Sex:Year, data = DataSet)
model10 <- lm(EnergyPDry_1_mJ_g~ Gonad_Wt_g + Collection_Location + Sex + Year, data = DataSet)
...
EDaic_df$ModelName <- c("EnergyPDry_1_mJ_g~ Gonad_Wt_g + Collection_Location + Sex + Year",
                        "EnergyPDry_1_mJ_g~ Gonad_Wt_g + Collection_Location + Year",
                        "EnergyPDry_1_mJ_g~ Gonad_Wt_g + Collection_Location + Sex",
                        "EnergyPDry_1_mJ_g~ Gonad_Wt_g + Collection_Location",
                        "EnergyPDry_1_mJ_g~ Gonad_Wt_g + Collection_Location + Sex + Collection_Location:Sex",
                        "EnergyPDry_1_mJ_g~ Gonad_Wt_g + Sex + Year",
                        "EnergyPDry_1_mJ_g~Gonad_Wt_g + Sex + Year + Sex:Year",
                        "EnergyPDry_1_mJ_g~Gonad_Wt_g + Year",
                        "EnergyPDry_1_mJ_g~ Gonad_Wt_g + Sex",
                        "EnergyPDry_1_mJ_g~1")
