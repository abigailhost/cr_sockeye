...
model3 <- lm(bodysize_pc_g_mm~Collection_RiverMile_m + Group_Assignment + Sex, data = DataSet)
model4 <- lm(bodysize_pc_g_mm~Collection_RiverMile_m + Group_Assignment + Year, data = DataSet)
model5 <- lm(bodysize_pc_g_mm~Collection_RiverMile_m + Group_Assignment + Sex + Year, data = DataSet)
...
aic_df$ModelName <- c("bodysize_pc_g_mm~Collection_RiverMile_m + Group_Assignment + Sex",
...
manual_likelihoods <- c(
  "(Intercept)" = 1.0,
  "Collection_RiverMile_m" = 0.9892733,
  "Group_AssignmentChitina" = 0.9892733,
  "Group_AssignmentGulkana" = 0.9892733,
  "Group_AssignmentGulkanaHatchery" = 0.9892733,
  "Group_AssignmentKlutinaLake" = 0.9892733,
  "Group_AssignmentKlutinaTonsinaOutlet" = 0.9892733,
  "Group_AssignmentLowerGroups" = 0.9892733,
  "Group_AssignmentSlana" = 0.9892733,
  "Group_AssignmentTanadaCopperLakes" = 0.9892733,
  "Group_AssignmentTazlina" = 0.9892733,
  "SexM" = 0.7414762,
  "Year2021" = 0.4475633
)
