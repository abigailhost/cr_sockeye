...
model5 <- lm(bodysize_pc_g_mm~Collection_RiverMile_m + Group_Assignment + Sex, data = DataSet)
model6 <- lm(bodysize_pc_g_mm~Collection_RiverMile_m + Group_Assignment + Year, data = DataSet)
model7 <- lm(bodysize_pc_g_mm~Collection_RiverMile_m + Sex + Year, data = DataSet)
model8 <- lm(bodysize_pc_g_mm~Collection_RiverMile_m + Group_Assignment + Sex + Group_Assignment:Sex, data = DataSet)
model9 <- lm(bodysize_pc_g_mm~Collection_RiverMile_m + Sex + Year + Sex:Year, data = DataSet)
model10 <- lm(bodysize_pc_g_mm~Collection_RiverMile_m + Group_Assignment + Sex + Year, data = DataSet)
...
aic_df$ModelName <- c("bodysize_pc_g_mm~Collection_RiverMile_m + Sex",
                      ...
                      "bodysize_pc_g_mm~Collection_RiverMile_m + Group_Assignment + Sex + Year",
                      "bodysize_pc_g_mm~Collection_RiverMile_m + Year",
                      "bodysize_pc_g_mm~Collection_RiverMile_m + Group_Assignment + Year",
                      "bodysize_pc_g_mm~Collection_RiverMile_m + Group_Assignment",
                      "bodysize_pc_g_mm~1",
                      "bodysize_pc_g_mm~Collection_RiverMile_m + Group_Assignment + Sex + Group_Assignment:Sex")
...
manual_likelihoods <- c(
  "(Intercept)" = 1.0,
  "Collection_RiverMile_m" = 0.9983258,
  "Group_AssignmentChitina" = 0.1544694,
  "Group_AssignmentGulkana" = 0.1544694,
  "Group_AssignmentGulkanaHatchery" = 0.1544694,
  "Group_AssignmentKlutinaLake" = 0.1544694,
  "Group_AssignmentKlutinaTonsinaOutlet" = 0.1544694,
  "Group_AssignmentLowerGroups" = 0.1544694,
  "Group_AssignmentSlana" = 0.1544694,
  "Group_AssignmentTanadaCopperLakes" = 0.1544694,
  "Group_AssignmentTazlina" = 0.1544694,
  "SexM" = 0.9147175,
  "Year2020" = 0.4902235,
  "Year2021" = 0.4902235,
  "SexM:Year2020" = 0.1048871,
  "SexM:Year2021" = 0.1048871,
  "Group_AssignmentChitina:SexM" = 0.00006454328,
  "Group_AssignmentGulkana:SexM" = 0.00006454328, 
  "Group_AssignmentGulkanaHatchery:SexM" = 0.00006454328, 
  "Group_AssignmentKlutinaLake:SexM" = 0.00006454328,
  "Group_AssignmentKlutinaTonsinaOutlet:SexM" = 0.00006454328,
  "Group_AssignmentLowerGroups:SexM" = 0.00006454328, 
  "Group_AssignmentSlana:SexM" = 0.00006454328, 
  "Group_AssignmentTanadaCopperLakes:SexM" = 0.00006454328,
  "Group_AssignmentTazlina:SexM" = 0.00006454328
)
