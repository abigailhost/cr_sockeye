...
GSI_runtiming <- ggplot(DataSet, aes(x = RunTimingGroup, fill = Group_Assignment)) +
...
ggsave(
  filename = "AICFigures/RTG_GSI_Distribution.jpeg",    # output file name
  plot = GSI_runtiming,              # the ggplot object
