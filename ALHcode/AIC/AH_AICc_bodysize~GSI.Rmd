...
# Use recoding to fix inconsistencies
levels(DataSet$Group_Assignment) <- recode_levels <- c(
  "Bremner" = "Bremner",
  "Chitina" = "Chitina",
  "Gulkana" = "Gulkana",
  "Gulkana " = "Gulkana",  # merge with "Gulkana"
  "Gulkanahatchery" = "GulkanaHatchery",
  "GulkanaHatchery" = "GulkanaHatchery",
  "insufficient genotypes" = "insufficient_genotypes" ,
  "KlutinaLake" = "KlutinaLake",
  "KlutinaTonsinaOutlet" = "KlutinaTonsinaOutlet",
  "KlutinaTonsinaOutlets" = "KlutinaTonsinaOutlet",  # merged
  "LowerGroups" = "LowerGroups",
  "Slana" = "Slana",
  "TanadaCopperLakes" = "TanadaCopperLakes",
  "Tazlina" = "Tazlina"
)

# Confirm new levels
levels(DataSet$Group_Assignment) #now these have been merged properly
...
print(coefs_df)
write.csv(coefs_df, "bodysize_GSI/bodysize_GSI_ModelAvg_Coefs_withLikelihoods.csv", row.names = FALSE)
