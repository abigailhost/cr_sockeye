...
GSI.work.condition <- work.condition +
  ...
  geom_text(
    ...
    size = 16, fontface = "bold",  # adjust size/style
    inherit.aes = FALSE
  )
...
ggsave(
  filename = "AICFigures/Work_GSI_Fineness_RegressionPlot.jpeg",    # output file name
  plot = work.fineness1,              # the ggplot object
  width = 18,                     # width in inches
  height = 12,                    # height in inches
  dpi = 300                        # resolution (higher = better quality)
)
...
ggsave(
  filename = "AICFigures/Work_SP_Fineness_RegressionPlot.jpeg",    # output file name
  plot = work.fineness1,              # the ggplot object
  width = 18,                     # width in inches
  height = 12,                    # height in inches
  dpi = 300                        # resolution (higher = better quality)
