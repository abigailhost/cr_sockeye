...
model3 <- lm(TotalEnergy_mJ~Collection_RiverMile_m + Sex, data = DataSet)
model4 <- lm(TotalEnergy_mJ~Collection_RiverMile_m + Year, data = DataSet)
model5 <- lm(TotalEnergy_mJ~Collection_RiverMile_m + Group_Assignment + Sex, data = DataSet)
model6 <- lm(TotalEnergy_mJ~Collection_RiverMile_m + Group_Assignment + Year, data = DataSet)
model7 <- lm(TotalEnergy_mJ~Collection_RiverMile_m + Sex + Year, data = DataSet)
model8 <- lm(TotalEnergy_mJ~Collection_RiverMile_m + Group_Assignment + Sex + Group_Assignment:Sex, data = DataSet)
model9 <- lm(TotalEnergy_mJ~Collection_RiverMile_m + Sex + Year + Sex:Year, data = DataSet)
model10 <- lm(TotalEnergy_mJ~Collection_RiverMile_m + Group_Assignment + Sex + Year, data = DataSet)
...
aic_df$ModelName <- c("TotalEnergy_mJ~Collection_RiverMile_m + Group_Assignment + Sex",
                      ...
                      "TotalEnergy_mJ~Collection_RiverMile_m + Sex + Year",
                      "TotalEnergy_mJ~Collection_RiverMile_m + Sex + Year + Sex:Year",
                      "TotalEnergy_mJ~Collection_RiverMile_m + Year",
                      "TotalEnergy_mJ~Collection_RiverMile_m + Group_Assignment + Sex + Group_Assignment:Sex",
                      "TotalEnergy_mJ~1")
...
manual_likelihoods <- c(
  ...
  "Group_AssignmentChitina" = 0.9479959708,
  "Group_AssignmentGulkana" = 0.9479959708,
  "Group_AssignmentGulkanaHatchery" = 0.9479959708,
  "Group_AssignmentKlutinaLake" = 0.9479959708,
  "Group_AssignmentKlutinaTonsinaOutlet" = 0.9479959708,
  "Group_AssignmentLowerGroups" = 0.9479959708,
  "Group_AssignmentSlana" = 0.9479959708,
  "Group_AssignmentTanadaCopperLakes" = 0.9479959708,
  "Group_AssignmentTazlina" = 0.9479959708,
  "SexM" = 0.7201116226,
  "Year2020" = 0.2284819945,
  "Year2021" = 0.2284819945,
  "SexM:Year2020" = 0.0043510732,
  "SexM:Year2021" = 0.0043510732,
  "Group_AssignmentChitina:SexM" = 0.0006064267,
  "Group_AssignmentGulkana:SexM" = 0.0006064267, 
  "Group_AssignmentGulkanaHatchery:SexM" = 0.0006064267, 
  "Group_AssignmentKlutinaLake:SexM" = 0.0006064267,
  "Group_AssignmentKlutinaTonsinaOutlet:SexM" = 0.0006064267,
  "Group_AssignmentLowerGroups:SexM" = 0.0006064267, 
  "Group_AssignmentSlana:SexM" = 0.0006064267, 
  "Group_AssignmentTanadaCopperLakes:SexM" = 0.0006064267,
  "Group_AssignmentTazlina:SexM" = 0.0006064267
)
