...
model2 <- lm(fineness~Collection_RiverMile_m + juliandate, data = DataSet)
model3 <- lm(fineness~Collection_RiverMile_m + Sex, data = DataSet)
model4 <- lm(fineness~Collection_RiverMile_m + juliandate + Sex, data = DataSet)
...
aic_df$ModelName <- c("fineness~Collection_RiverMile_m + juliandate",
                      "fineness~Collection_RiverMile_m + juliandate + Sex",
...
#models for fineness
model1 <- lm(fineness~1, data=DataSet)
model2 <- lm(fineness~Collection_RiverMile_m + juliandate + Group_Assignment, data = DataSet)
model3 <- lm(fineness~Collection_RiverMile_m + juliandate + Sex, data = DataSet)
model4 <- lm(fineness~Collection_RiverMile_m + juliandate + Group_Assignment + Sex, data = DataSet)


ggplot(data = DataSet, aes(x = juliandate, y = fineness)) +
...
# Convert AIC table to a data frame for easier manipulation
aic_df <- as.data.frame(myaicc1)
aic_df$ModelName <- c("fineness~Collection_RiverMile_m + juliandate + Sex",
                      "fineness~Collection_RiverMile_m + juliandate + Group_Assignment + Sex",
                      "fineness~Collection_RiverMile_m + juliandate + Group_Assignment",
                      "fineness~1")
...
manual_likelihoods <- c(
  ...
  "juliandate" = 1.000000,
  "Group_AssignmentChitina" = 0.00386804,
  "Group_AssignmentGulkana" = 0.00386804,
  "Group_AssignmentGulkanaHatchery" = 0.00386804,
  "Group_AssignmentKlutinaLake" = 0.00386804,
  "Group_AssignmentKlutinaTonsinaOutlet" = 0.00386804,
  "Group_AssignmentSlana" = 0.00386804,
  "Group_AssignmentTanadaCopperLakes" = 0.00386804,
  "Group_AssignmentTazlina" = 0.00386804,
  "SexM" = 0.99866114	
)
