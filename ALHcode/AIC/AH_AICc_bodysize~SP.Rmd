...
upperriver_bodycomp_all <- upperriver_bodycomp_all %>%
  filter(!Collection_Location %in% c("Power Creek Cordova", "Eyak Weir Cordova", "Bone Creek", "Copper Lake", "Klutina River", "Upper Klutina", "Klutina River"))


### Now, need to remove NAs that will mess up levels / model weight
any(is.na(upperriver_bodycomp_all$Collection_Location))
any(is.na(upperriver_bodycomp_all$Migratory_Difficulty))
...
any(is.na(DataSet$Migratory_Difficulty)) # FALSE
...
levels(DataSet$SpawnStatus) # 4 levels
str(DataSet)
...
model2 <- lm(bodysize_pc~ SpawnStatus + Migratory_Difficulty, data = DataSet)
model3 <- lm(bodysize_pc~ SpawnStatus + Sex, data = DataSet)
model4 <- lm(bodysize_pc~SpawnStatus + Year, data = DataSet)
model5 <- lm(bodysize_pc~ SpawnStatus + Migratory_Difficulty + Sex, data = DataSet)
model6 <- lm(bodysize_pc~ SpawnStatus + Migratory_Difficulty + Year, data = DataSet)
model7 <- lm(bodysize_pc~ SpawnStatus + Sex + Year, data = DataSet)
model8 <- lm(bodysize_pc~ SpawnStatus + Migratory_Difficulty + Sex + Migratory_Difficulty:Sex, data = DataSet)
model9 <- lm(bodysize_pc~ SpawnStatus + Migratory_Difficulty + Year + Migratory_Difficulty:Year, data = DataSet)
model10 <- lm(bodysize_pc~SpawnStatus + Sex + Year + Sex:Year, data = DataSet)
model11 <- lm(bodysize_pc~ SpawnStatus + Migratory_Difficulty + Sex + Year, data = DataSet)
```
...
aic_df$ModelName <- c("bodysize_pc~ SpawnStatus + Sex",
                      "bodysize_pc~ SpawnStatus + Sex + Year",
                      "bodysize_pc~ SpawnStatus + Migratory_Difficulty + Sex",
                      "bodysize_pc~ SpawnStatus + Migratory_Difficulty + Sex + Year",
                      "bodysize_pc~SpawnStatus + Sex + Year + Sex:Year",
                      "bodysize_pc~ SpawnStatus + Migratory_Difficulty + Sex + Migratory_Difficulty:Sex",
                      "bodysize_pc~ SpawnStatus + Migratory_Difficulty",
                      "bodysize_pc~ SpawnStatus + Migratory_Difficulty + Year",
                      "(bodysize_pc~SpawnStatus + Year",
                      "bodysize_pc~ SpawnStatus + Migratory_Difficulty + Year + Migratory_Difficulty:Year",
                      "bodysize_pc~1")
