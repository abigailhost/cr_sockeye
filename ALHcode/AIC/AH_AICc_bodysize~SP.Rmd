...
model2 <- lm(bodysize_pc_g_mm~ Gonad_Wt_g + Work, data = DataSet)
model3 <- lm(bodysize_pc_g_mm~ Gonad_Wt_g + Sex, data = DataSet)
model4 <- lm(bodysize_pc_g_mm~ Gonad_Wt_g + Year, data = DataSet)
model5 <- lm(bodysize_pc_g_mm~ Gonad_Wt_g + Work + Sex, data = DataSet)
model6 <- lm(bodysize_pc_g_mm~ Gonad_Wt_g + Work + Year, data = DataSet)
model7 <- lm(bodysize_pc_g_mm~ Gonad_Wt_g + Sex + Year, data = DataSet)
model8 <- lm(bodysize_pc_g_mm~ Gonad_Wt_g + Work + Sex + Work:Sex, data = DataSet)
model9 <- lm(bodysize_pc_g_mm~ Gonad_Wt_g + Work + Year + Work:Year, data = DataSet)
model10 <- lm(bodysize_pc_g_mm~Gonad_Wt_g + Sex + Year + Sex:Year, data = DataSet)
model11 <- lm(bodysize_pc_g_mm~ Gonad_Wt_g + Work + Sex + Year, data = DataSet)
summary(model11)
```
...
print(model_sel)  # optional: see the AIC comparison table

# Model averaging (conditional averaging recommended)
model_avg <- model.avg(model_sel, full = FALSE)
summary(model_avg)
