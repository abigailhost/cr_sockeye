...
aic_df$ModelName <- c("bodysize_pc_g_mm~ Gonad_Wt_g + Sex + Year",
                      "bodysize_pc_g_mm~Gonad_Wt_g + Sex + Year + Sex:Year",
                      "bodysize_pc_g_mm~ Gonad_Wt_g + Work + Sex + Year",
                      "bodysize_pc_g_mm~ Gonad_Wt_g + Sex",
                      "bodysize_pc_g_mm~ Gonad_Wt_g + Work + Sex",
                      "bodysize_pc_g_mm~ Gonad_Wt_g + Work + Sex + Work:Sex",
                      "bodysize_pc_g_mm~ Gonad_Wt_g + Year",
                      "bodysize_pc_g_mm~ Gonad_Wt_g + Work + Year",
                      "bodysize_pc_g_mm~1",
                      "bodysize_pc_g_mm~ Gonad_Wt_g + Work",
                      "bodysize_pc_g_mm~ Gonad_Wt_g + Work + Year + Work:Year")
...
manual_likelihoods <- c(
  ...
  "Year2020" = 0.9738555,
  "Year2021" = 0.9738555, 
  "SexM:Year2020" = 0.3555654,
  "SexM:Year2021" = 0.3555654,
  "Work" = 0.1745799,
  "SexM:Work" = 0.002743190,
  "Work:Year2020" = 5.042509e-23,
  "Work:Year2021" = 5.042509e-23
)
