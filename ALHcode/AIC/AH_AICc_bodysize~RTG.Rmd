...
coefs_df_full$ParamLikelihood <- manual_likelihoods[rownames(coefs_df)]

# View final table
print(coefs_df_full)

write.csv(coefs_df_full, file = "bodysize_runtiminggroup/bodysize~runtiminggroup_models_CoefEstimates_withLikelihoods.csv", row.names = TRUE)
```
