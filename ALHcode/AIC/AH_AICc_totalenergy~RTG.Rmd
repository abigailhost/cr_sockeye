...
```{r}
models <- list(
  lm(TotalEnergy ~ 1, data = DataSet),
  lm(TotalEnergy ~ Collection_RiverMile_m + RunTimingGroup, data = DataSet),
  lm(TotalEnergy ~ Collection_RiverMile_m + Sex, data = DataSet),
  lm(TotalEnergy ~ Collection_RiverMile_m + Year, data = DataSet),
  lm(TotalEnergy ~ Collection_RiverMile_m + RunTimingGroup + Sex, data = DataSet),
  lm(TotalEnergy ~ Collection_RiverMile_m + RunTimingGroup + Year, data = DataSet),
  lm(TotalEnergy ~ Collection_RiverMile_m + Sex + Year, data = DataSet),
  lm(TotalEnergy ~ Collection_RiverMile_m + RunTimingGroup + Sex + RunTimingGroup:Sex, data = DataSet),
  lm(TotalEnergy ~ Collection_RiverMile_m + Sex + Year + Sex:Year, data = DataSet),
  lm(TotalEnergy ~ Collection_RiverMile_m + RunTimingGroup + Sex + Year, data = DataSet)
  )
