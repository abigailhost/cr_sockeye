...
manual_likelihoods <- c(
  ...
  "RunTimingGroupLate" = 0.9893962106,
  "RunTimingGroupMiddle" = 0.9893962106,
  "SexM" = 0.9798975906,
  "Year2020" = 0.0955135790,
  "Year2021" = 0.0955135790,
  "RunTimingGroupLate:SexM" = 0.1284309811,
  "RunTimingGroupMiddle:SexM" = 0.1284309811,
  "SexM:Year2020" = 0.0004820978,
  "SexM:Year2021" = 0.0004820978
)
...
write.csv(coefs_df_full, file = "totalenergy_runtiminggroup/TotalEnergy~runtiminggroup_models_CoefEstimates_withLikelihoods.csv", row.names = TRUE)
```


### Figure that displays parameter estimates + CI for each parameter in the model set
```{r}
paramestimates_te <- "totalenergy_runtiminggroup/TotalEnergy~runtiminggroup_models_CoefEstimates_withLikelihoods.csv"
