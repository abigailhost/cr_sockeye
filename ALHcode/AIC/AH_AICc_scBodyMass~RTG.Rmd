...
DataSet$Fish_Leng_1_mm <- DataSet$Fish_Leng_1*10
DataSet$Fish_Leng_2_mm <- DataSet$Fish_Leng_2*10
DataSet$Fish_Leng_Total_mm <- DataSet$Fish_Leng_1_mm + DataSet$Fish_Leng_2
...
SCBMaic_df$ModelName <- c("sizecorrected_bodymass_residuals ~ Collection_RiverMile_m + Sex + Year + Sex:Year",
