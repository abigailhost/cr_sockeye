...
```{r}
models <- list(
  lm(EnergyPDry_1 ~ 1, data = DataSet),
  lm(EnergyPDry_1 ~ Collection_RiverMile_m + RunTimingGroup, data = DataSet),
  lm(EnergyPDry_1 ~ Collection_RiverMile_m + Sex, data = DataSet),
  lm(EnergyPDry_1 ~ Collection_RiverMile_m + Year, data = DataSet),
  lm(EnergyPDry_1 ~ Collection_RiverMile_m + RunTimingGroup + Sex, data = DataSet),
  lm(EnergyPDry_1 ~ Collection_RiverMile_m + RunTimingGroup + Year, data = DataSet),
  lm(EnergyPDry_1 ~ Collection_RiverMile_m + Sex + Year, data = DataSet),
  lm(EnergyPDry_1 ~ Collection_RiverMile_m + RunTimingGroup + Sex + RunTimingGroup:Sex, data = DataSet),
  lm(EnergyPDry_1 ~ Collection_RiverMile_m + Sex + Year + Sex:Year, data = DataSet),
  lm(EnergyPDry_1 ~ Collection_RiverMile_m + RunTimingGroup + Sex + Year, data = DataSet)
  )
