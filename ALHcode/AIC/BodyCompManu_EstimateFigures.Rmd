...
fineness_sp$X <- factor(fineness_sp$X,
                 levels = rev(c("(Intercept)", 
                                ...
                                "Collection_LocationTanada:SexM",
                                "SexM:Year2020",
                                "SexM:Year2021"))) #now data has all be re-leveled
...
levels(fineness_sp$X)[levels(fineness_sp$X) == "Year2020"] <- "2020"
levels(fineness_sp$X)[levels(fineness_sp$X) == "Year2021"] <- "2021"
