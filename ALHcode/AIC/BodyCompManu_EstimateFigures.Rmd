...
### Variation in body condition according to Run Timing Group
```{r coef_plot2, echo=FALSE, fig.width=16, fig.height=10, fig.align='center'}
plot(coef_plot2)
```
...
### Variation in body condition according to Run Timing Group
```{r coef_plot2, echo=FALSE, fig.width=12, fig.height=8, fig.align='center'}
plot(coef_plot2)
```
