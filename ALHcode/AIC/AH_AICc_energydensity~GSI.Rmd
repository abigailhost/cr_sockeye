...
model3 <- lm(EnergyPDry_1~Collection_RiverMile_m + Group_Assignment + Sex, data = DataSet)
model4 <- lm(EnergyPDry_1~Collection_RiverMile_m + Group_Assignment + Year, data = DataSet)
model5 <- lm(EnergyPDry_1~Collection_RiverMile_m + Group_Assignment + Sex + Year, data = DataSet)
...
manual_likelihoods <- c(
  ...
  "Group_AssignmentChitina" = 1.0000000,
  "Group_AssignmentGulkana" = 1.0000000,
  "Group_AssignmentGulkanaHatchery" = 1.0000000,
  "Group_AssignmentKlutinaLake" = 1.0000000,
  "Group_AssignmentKlutinaTonsinaOutlet" = 1.0000000,
  "Group_AssignmentLowerGroups" = 1.0000000,
  "Group_AssignmentSlana" = 1.0000000,
  "Group_AssignmentTanadaCopperLakes" = 1.0000000,
  "Group_AssignmentTazlina" = 1.0000000,
  "SexM" = 0.2753472,
  "Year2021" = 0.9999996)
