...
model4 <- lm(EnergyPDry_1~Collection_RiverMile_m + Year, data = DataSet)
model5 <- lm(EnergyPDry_1~Collection_RiverMile_m + Group_Assignment + Sex, data = DataSet)
model6 <- lm(EnergyPDry_1~Collection_RiverMile_m + Group_Assignment + Year, data = DataSet)
model7 <- lm(EnergyPDry_1~Collection_RiverMile_m + Sex + Year, data = DataSet)
model8 <- lm(EnergyPDry_1~Collection_RiverMile_m + Group_Assignment + Sex + Group_Assignment:Sex, data = DataSet)
model9 <- lm(EnergyPDry_1~Collection_RiverMile_m + Sex + Year + Sex:Year, data = DataSet)
model10 <- lm(EnergyPDry_1~Collection_RiverMile_m + Group_Assignment + Sex + Year, data = DataSet)
...
aic_df$ModelName <- c("EnergyPDry_1~Collection_RiverMile_m + Group_Assignment + Year",
                      "EnergyPDry_1~Collection_RiverMile_m + Group_Assignment + Sex + Year",
                      ...
                      "EnergyPDry_1~Collection_RiverMile_m + Group_Assignment",
                      "EnergyPDry_1~Collection_RiverMile_m + Group_Assignment + Sex",
                      "EnergyPDry_1~Collection_RiverMile_m + Sex",
                      "EnergyPDry_1~Collection_RiverMile_m + Group_Assignment + Sex + Group_Assignment:Sex",
                      "EnergyPDry_1~1")
...
manual_likelihoods <- c(
  ...
  "Group_AssignmentChitina" = 0.9999345,
  "Group_AssignmentGulkana" = 0.9999345,
  "Group_AssignmentGulkanaHatchery" = 0.9999345,
  "Group_AssignmentKlutinaLake" = 0.9999345,
  "Group_AssignmentKlutinaTonsinaOutlet" = 0.9999345,
  "Group_AssignmentLowerGroups" = 0.9999345,
  "Group_AssignmentSlana" = 0.9999345,
  "Group_AssignmentTanadaCopperLakes" = 0.9999345,
  "Group_AssignmentTazlina" = 0.9999345,
  "SexM" = 0.2753707,
  "Year2020" = 0.9999996,
  "Year2021" = 0.9999996,
  "SexM:Year2020" = 0.00003286614,
  "SexM:Year2021" = 0.00003286614,
  "Group_AssignmentChitina:SexM" = 0.00000000009263763,
  "Group_AssignmentGulkana:SexM" = 0.00000000009263763, 
  "Group_AssignmentGulkanaHatchery:SexM" = 0.00000000009263763, 
  "Group_AssignmentKlutinaLake:SexM" = 0.00000000009263763,
  "Group_AssignmentKlutinaTonsinaOutlet:SexM" = 0.00000000009263763,
  "Group_AssignmentLowerGroups:SexM" = 0.00000000009263763, 
  "Group_AssignmentSlana:SexM" = 0.00000000009263763, 
  "Group_AssignmentTanadaCopperLakes:SexM" = 0.00000000009263763,
  "Group_AssignmentTazlina:SexM" = 0.00000000009263763
)
