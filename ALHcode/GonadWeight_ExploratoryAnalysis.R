...
partial_spawn_data <- DataSet[DataSet$SpawnStatus == 1, ]
...
mean(partial_spawn_data$Gonad_Wt_g, na.rm = T) #mean weight is 31.5 grams
...
hist(partial_spawn_data$Gonad_Wt_g, 
...
hist(partial_spawn_data$Gonad_Wt_g[partialpost_spawn_data$Sex == "M"], 
...
hist(partial_spawn_data$Gonad_Wt_g[partialpost_spawn_data$Sex == "F"], 
