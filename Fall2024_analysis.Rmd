...
```
### Body Size, Energy Density & Run-Timing Group
```{r}
#2019
...
###sex and body size across run-timing
ggplot(data=lowerriver19, aes(runtime, y=Fish_Wt, fill = Sex)) + xlab("Run Timing Group") + ylab("Body Weight (kg)") + ggtitle("Sockeye Body Weight (kg) across run-timing group and Sex in Canyon Creek in 2019") + geom_boxplot() +  scale_fill_manual(values = c("#1F78B4", "#E31A1C")) +  theme(axis.title=element_text(size=14, face="bold"), axis.text.x = element_text(size=12), axis.text.y=element_text(size=12), title = element_text(size=16, face="bold"), legend.text = element_text(size=12)) + geom_jitter()

SexWeight19 <- lm(Fish_Wt ~ Sex, data = lowerriver19)
...
###sex and body size across run-timing
ggplot(data=subset(lowerriver20, !is.na(Sex)), aes(runtime, y=Fish_Wt, fill = Sex)) + xlab("Run Timing Group") + ylab("Body Weight (kg)") + ggtitle("Sockeye Body Weight (kg) across run-timing group and Sex in Canyon Creek in 2020") + geom_boxplot() +  scale_fill_manual(values = c("#1F78B4", "#E31A1C")) +  theme(axis.title=element_text(size=14, face="bold"), axis.text.x = element_text(size=12), axis.text.y=element_text(size=12), title = element_text(size=16, face="bold"), legend.text = element_text(size=12)) + geom_jitter()

SexWeight20 <- lm(Fish_Wt ~ Sex, data = subset(lowerriver20, !is.na(Sex)))
...
###sex and body size across run-timing
ggplot(data=lowerriver21, aes(runtime, y=Fish_Wt, fill = Sex)) + xlab("Run Timing Group") + ylab("Body Weight (kg)") + ggtitle("Sockeye Body Weight (kg) across run-timing group and Sex in Canyon Creek in 2021") + geom_boxplot() +  scale_fill_manual(values = c("#1F78B4", "#E31A1C")) +  theme(axis.title=element_text(size=14, face="bold"), axis.text.x = element_text(size=12), axis.text.y=element_text(size=12), title = element_text(size=16, face="bold"), legend.text = element_text(size=12)) + geom_jitter()

SexWeight21 <- lm(Fish_Wt ~ Sex, data = lowerriver21)
...
#grouped plot-- Sex and Energy density across run-timing group and sex
lowsexE19 <- ggplot(lowerriver19, aes(runtime, y=EnergyDensity_mJ.kg_1, fill = Sex)) + xlab("Run Timing Group") + ylab("Energy Density (mJ/kg)") + ggtitle("2019") + geom_boxplot(lwd=1.5) +  scale_fill_manual(values = c("#1F78B4", "#E31A1C")) + ylim(20,30) + theme(axis.title=element_text(size=24, face="bold"), axis.text.x = element_text(size=24), axis.text.y=element_text(size=24), title = element_text(size=24, face="bold"), legend.position = "none") + geom_jitter()

lowsexE20 <- ggplot(data=subset(lowerriver20, !is.na(Sex)), aes(runtime, y=EnergyDensity_mJ.kg_1, fill = Sex)) + xlab("Run Timing Group") + ylab("Energy Density (mJ/kg)") + ggtitle("2020") + geom_boxplot(lwd=1.5) +  scale_fill_manual(values = c("#1F78B4", "#E31A1C")) + ylim(20,30) + theme(axis.title=element_text(size=24, face="bold"), axis.text.x = element_text(size=24), axis.title.y=element_blank(), axis.text.y=element_text(size=24), title = element_text(size=24, face="bold"), legend.position = "none") + geom_jitter()

lowsexE21 <- ggplot(lowerriver21, aes(runtime, y=EnergyDensity_mJ.kg_1, fill = Sex)) + xlab("Run Timing Group") + ylab("Energy Density (mJ/kg)") + ggtitle("2021") + geom_boxplot(lwd=1.5) +  scale_fill_manual(values = c("#1F78B4", "#E31A1C")) + ylim(20,30) + theme(axis.title=element_text(size=24, face="bold"), axis.text.x = element_text(size=24),  axis.title.y=element_blank(), axis.text.y=element_text(size=24), title = element_text(size=24, face="bold"), legend.text = element_text(size=24)) + geom_jitter()

grid.arrange(lowsexE19, lowsexE20, lowsexE21, ncol = 3)


#grouped plot-- Sex and Body Weight across run-timing group and Sex
...
#Sex and Body Size (weight, kg), over all run-timing groups (2019-2020)
anova(SexWeight19)
anova(SexWeight20)
anova(SexWeight21)
...
upper19new <- ggplot(upperriver19, aes(site, y=EnergyDensity_mJ.kg_1, fill = site)) + xlab("Sampling Site") + ylab("Energy Density (mJ/kg)") + ggtitle("2019") + geom_boxplot(lwd=1.5) +  scale_fill_manual(values = c( "#5E4FA2", "#CAB2D6","#33A02C","#FF7F00","#1F78B4","#B2DF8A")) + ylim(15,26)+ theme(axis.title=element_text(size=24, face="bold"), axis.text.x = element_text(size=24), axis.text.y=element_text(size=24), title = element_text(size=24, face="bold"), legend.position = "none") + geom_jitter()
